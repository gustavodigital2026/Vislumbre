  ...
  return (
    <div
      style={{
        ...
        overflowY: "auto",
        overflowX: "hidden", // Remove barra lateral
        scrollbarGutter: "stable", // Reserva espaço para barra vertical não pular o layout
        display: "flex",
    ...
    >
      ...
      >
        {/* Busca Texto - Ajustado para não vazar */}
        <input
          type="text"
        ...
        >
          <div style={{ flex: 1 }}>
            <label
              style={{ display: "block", marginBottom: "2px", opacity: 0.8 }}
            >
              De:
            </label>
            <input
      ...
      {aba === "leads" && !termoBusca && (
        ...
        >
          <label
            style={{ fontSize: "12px", color: "#7f8c8d", fontWeight: "bold" }}
          >
            NOVO WHATSAPP:
          </label>
      ...
      <div style={{ padding: "10px" }}>
        {lista.length === 0 && (
          <p
            style={{ color: "#95a5a6", textAlign: "center", marginTop: "20px" }}
          >
        ...
        {lista.map((p) => {
          const dataMostrada =
            aba === "finalizados" && p.dataSaida ? p.dataSaida : p.dataEntrada;
          ...
          return (
            <div
              ...
              style={{
                ...
                borderRadius: "6px",
                boxShadow:
                  idSelecionado === p.id ? "0 2px 8px rgba(0,0,0,0.1)" : "none",
                transition: "all 0.2s",
              }}
            >
              <div
